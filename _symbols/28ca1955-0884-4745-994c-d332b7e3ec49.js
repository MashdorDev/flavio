// Video Embed - Updated November 28, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(aside, "class", "svelte-1s3b3tv");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('video_embed' in $$props) $$invalidate(2, video_embed = $$props.video_embed);
	};

	return [label, props, video_embed];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 1, label: 0, video_embed: 2 });
	}
}
