// Site Footer - Updated November 28, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-19wx290");
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(h4, "class", "label svelte-19wx290");
			attr(nav, "class", "svelte-19wx290");
			attr(div, "class", "item svelte-19wx290");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-19wx290");
			attr(div0, "class", "company-description svelte-19wx290");
			attr(div1, "class", "main svelte-19wx290");
			attr(div2, "class", "links svelte-19wx290");
			attr(footer, "class", "section-container svelte-19wx290");
		},
		m(target, anchor) {
